...
import { isPersistableState, SESSION_SCHEMA_VERSION } from "./types.js";
...
async function applyEffects(deps, currentState, effects) {
...
async function persistStateIfNeeded(deps, previousState, nextState, savedAtMs) {
